...
<div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Data Persembahan Mingguan</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">Data Persembahan Mingguan</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    ...
    <div class="container">
        <a href="/tambahperming" class="btn btn-success">Tambah +</a>
            ...
            <table class="table">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <a href="#" class="btn btn-danger delete" data-id="{{ $row->id }}" data-nama="{{ $row->tanggal }}">Hapus</a>
                    </td>
                  </tr>
                @endforeach
...
<script>
    $('.delete').click( function(){
        ...
        swal({
                ...
                .then((willDelete) => {
                if (willDelete) {
                    window.location = "/delete/"+persembahanid+""
                    swal("Data Persembahan berhasil dihapus!", {
                    icon: "success",
                    });
                } else {
                    swal("Data Persembahan tidak jadi dihapus!");
                }
                });
    });
</script>
