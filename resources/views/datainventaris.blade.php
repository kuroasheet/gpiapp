...
<div class="content-wrapper">
    ...
    <div class="container">
        <a href="/tambahinventaris" class="btn btn-success">Tambah +</a>
            ...
            <table class="table">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <a href="#" class="btn btn-danger delete" data-id="{{ $row->id }}" data-nama="{{ $row->namabarang }}">Hapus</a>
                    </td>
                  </tr>
                @endforeach
...
<script>
    $('.delete').click( function(){
        ...
        swal({
                ...
                .then((willDelete) => {
                if (willDelete) {
                    window.location = "/delete/"+inventarisid+""
